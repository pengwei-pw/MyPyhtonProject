...
def demo3():
    ...
    for index, row in df1.iterrows():
        ...
        cell = ws.cell(row=index + 2 + 2*index, column=15)
        cell.value = ''

        ws.merge_cells(start_row=index + 2 + 2*index, start_column=16, end_row=index + 2 + 2*(index+1), end_column=16)
        cell = ws.cell(row=index + 2 + 2*index, column=16)
        cell.value = 'Feasible'


    wb.save(r'C:\Users\pengw\Desktop\LLM\testrail_upllm.xlsx')
